...
function buildLeafletMap(centerLat, centerLng, h) {
  ...
  L.tileLayer('https://{s}.basemaps.cartocdn.com/dark_matter_lite/{z}/{x}/{y}{r}.png', { maxZoom: 20 }).addTo(map);
...
window.loadEmpreinteMap = async () => {
  ...
  try {
    ...
    L.tileLayer('https://{s}.basemaps.cartocdn.com/dark_matter_lite/{z}/{x}/{y}{r}.png', { maxZoom: 20 }).addTo(_empreinteMap);
...
window.showPublicProfileModal = (uid, name, ghostCount, totalOpens, ghostDocs) => {
  ...
  setTimeout(() => {
    ...
    L.tileLayer('https://{s}.basemaps.cartocdn.com/dark_matter_lite/{z}/{x}/{y}{r}.png', { maxZoom: 19 }).addTo(pubMap);
...
window.setChainMarker = () => {
  ...
  const initChainMap = () => {
    ...
    L.tileLayer('https://{s}.basemaps.cartocdn.com/dark_matter_lite/{z}/{x}/{y}{r}.png', { maxZoom: 20 }).addTo(cmap);
