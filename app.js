...
window.loadEmpreinteMap = async () => {
  ...
  try {
    ...
    L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png', { maxZoom: 20 }).addTo(_empreinteMap);
...
window.showPublicProfileModal = (uid, name, ghostCount, totalOpens, ghostDocs) => {
  ...
  setTimeout(() => {
    ...
    L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png', { maxZoom: 19 }).addTo(pubMap);
...
window.setChainMarker = () => {
  ...
  const initChainMap = () => {
    ...
    L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png', { maxZoom: 20 }).addTo(cmap);
